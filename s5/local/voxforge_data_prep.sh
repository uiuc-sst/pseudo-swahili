...
if [ ! -s $loctmp/dir_train.txt ]; then
  #;;;; Do a git pull request for this test->train typo, for all data_prep.sh where this was copypasted from.
  #;;;; Rewrite as "for s in train test; do".
